...
export default function ProjectSupportPage() {
  ...
  return (
    <div>
      <section className="px-4 pb-28 pt-32 sm:px-6 sm:pb-32 lg:px-8 lg:pb-[9.5rem] lg:pt-40">
        <div className="container-custom">
          <div className="grid items-center gap-10 lg:grid-cols-[0.96fr_1.04fr] lg:gap-14">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-5 text-balance font-heading text-[3.35rem] font-semibold leading-[0.94] tracking-[-0.04em] text-[#2C2C2C] sm:text-[4.5rem] lg:text-[5.2rem]">
        ...
        <div className="container-custom">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2">
            {SUPPORT_SCOPE.map(card => (
              <article
                key={card.title}
                className="rounded-[1.8rem] border border-primary/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(246,240,228,0.72))] p-7 shadow-[0_18px_50px_rgba(26,24,22,0.04)]"
              >
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {HOSPITALITY_SUPPORT.map(card => (
              <article key={card.title} className="section-shell p-7">
                <h3 className="font-heading text-3xl font-semibold text-neutral-900">{card.title}</h3>
                <p className="mt-4 text-sm leading-7 text-neutral-700 sm:text-base">
                  {card.description}
                </p>
              </article>
        ...
        <div className="container-custom">
          ...
          <div className="mt-12 grid gap-5 xl:grid-cols-5">
            {PROCESS_STEPS.map(step => (
              <article key={step.number} className="section-shell p-6">
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-primary/70">
                  {step.number}
                </p>
                <h3 className="mt-4 font-heading text-[2rem] font-semibold leading-tight text-neutral-900">
                  {step.title}
                </h3>
        ...
        <div className="container-custom">
          <div className="section-shell p-8 sm:p-10 lg:p-12">
            <div className="max-w-4xl">
              ...
              <h2 className="mt-5 text-balance font-heading text-4xl font-semibold leading-tight text-[#2C2C2C] sm:text-5xl lg:text-6xl">
