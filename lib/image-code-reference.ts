...
export const IMAGE_CODE_REFERENCES: ImageCodeReference[] = [
  ...
  { code: 'LXA-HWS-05', page: 'Hardware Systems', pageHref: '/hardware-systems', label: 'Track systems ceiling integration image', src: '/images/luxaura/hero-project.webp' },
  { code: 'LXA-HWS-06', page: 'Hardware Systems', pageHref: '/hardware-systems', label: 'Track systems large-span support image', src: '/images/luxaura/vertical-sheer-pool.webp' },
  { code: 'LXA-HWS-07', page: 'Hardware Systems', pageHref: '/hardware-systems', label: 'Motorisation feature image', src: '/images/IMG-I.webp' },
  { code: 'LXA-HWS-08', page: 'Hardware Systems', pageHref: '/hardware-systems', label: 'Motorisation lifestyle detail image', src: '/images/luxaura/vertical-sheer-pool.webp' },
  { code: 'LXA-HWS-09', page: 'Hardware Systems', pageHref: '/hardware-systems', label: 'Motorisation track detail image', src: '/images/carousel/09-Curtain-Track.webp' },
  { code: 'LXA-HWS-10', page: 'Hardware Systems', pageHref: '/hardware-systems', label: 'Range and value feature image', src: '/images/IMG-H.webp' },
  { code: 'LXA-HWS-11', page: 'Hardware Systems', pageHref: '/hardware-systems', label: 'Installation intelligence image', src: '/images/luxaura/vertical-sheer-pool.webp' },
  ...
  { code: 'LXA-DTR-06', page: 'Decorative Trimmings', pageHref: '/decorative-trimmings', label: 'Latest collection tailored trim detail', src: '/images/IMG-H.webp' },
  { code: 'LXA-DTR-07', page: 'Decorative Trimmings', pageHref: '/decorative-trimmings', label: 'Latest collection soft detail close-up', src: '/images/IMG-J.webp' },
  { code: 'LXA-DTR-08', page: 'Decorative Trimmings', pageHref: '/decorative-trimmings', label: 'Application image: On Drapery', src: '/images/IMG-B.webp' },
  { code: 'LXA-DTR-09', page: 'Decorative Trimmings', pageHref: '/decorative-trimmings', label: 'Application image: On Upholstery', src: '/images/luxaura/upholstery-pillows.webp' },
  { code: 'LXA-DTR-10', page: 'Decorative Trimmings', pageHref: '/decorative-trimmings', label: 'Application image: On Cushions & Bedding', src: '/images/IMG-D.webp' },
  { code: 'LXA-DTR-11', page: 'Decorative Trimmings', pageHref: '/decorative-trimmings', label: 'Application image: On Feature Pieces', src: '/images/IMG-C.webp' },
  { code: 'LXA-DTR-12', page: 'Decorative Trimmings', pageHref: '/decorative-trimmings', label: 'Creative development feature image', src: '/images/IMG-H.webp' },

  { code: 'LXA-ABOUT-01', page: 'About & Trade Desk', pageHref: '/about', label: 'Hero image', src: '/images/about-hero.webp' },
  { code: 'LXA-ABOUT-02', page: 'About & Trade Desk', pageHref: '/about', label: 'Brand positioning support image', src: '/images/luxaura/hero-project.webp' },
  { code: 'LXA-ABOUT-03', page: 'About & Trade Desk', pageHref: '/about', label: 'Closing reassurance image', src: '/images/luxaura/beach-sheer.webp' },
