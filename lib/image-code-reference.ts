...
export const IMAGE_CODE_REFERENCES: ImageCodeReference[] = [
  ...
  { code: 'LXA-WIN-04', page: 'Window Treatments', pageHref: '/custom-curtains-sheers', label: 'Tailored style: Box Pleat', src: '/images/curtains-hero.webp' },
  { code: 'LXA-WIN-05', page: 'Window Treatments', pageHref: '/custom-curtains-sheers', label: 'Tailored style: Tailored Headings', src: '/images/IMG-C.webp' },
  { code: 'LXA-WIN-06', page: 'Window Treatments', pageHref: '/custom-curtains-sheers', label: 'Tailored style: Roman Blinds', src: '/images/IMG-G.webp' },
  { code: 'LXA-WIN-07', page: 'Window Treatments', pageHref: '/custom-curtains-sheers', label: 'Tailored style: Layered Sheer + Drape Systems', src: '/images/luxaura/beach-sheer.webp' },
  ...
  { code: 'LXA-WIN-13', page: 'Window Treatments', pageHref: '/custom-curtains-sheers#roman-blinds', label: 'Roman blind style: Flat & Ribbed', src: '/images/IMG-G.webp' },
  { code: 'LXA-WIN-14', page: 'Window Treatments', pageHref: '/custom-curtains-sheers#roman-blinds', label: 'Roman blind style: Relaxed & London', src: '/images/IMG-F.webp' },
  { code: 'LXA-WIN-15', page: 'Window Treatments', pageHref: '/custom-curtains-sheers#roman-blinds', label: 'Roman blind workmanship detail', src: '/images/IMG-C.webp' },
